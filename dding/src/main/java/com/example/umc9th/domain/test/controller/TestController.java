...
import com.example.umc9th.domain.test.service.command.TestCommandService;
...
public class TestController {
    ...
    public ApiResponse<TestResDTO.CreateTestEntityResultDTO> createTestEntity(@RequestBody TestReqDTO.Testing request) {
        TestEntity entity = testCommandService.createTestEntity(request);
        return ApiResponse.onSuccess(GeneralSuccessCode.OK, TestConverter.toCreateTestEntityResultDTO(entity));
    }
}
